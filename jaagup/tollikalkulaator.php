<!doctype html>
<html>
<head><title>Arvutamine</title></head>
<body><h1>Tollikalkulaator</h1>
...
if (empty($_REQUEST["tollid"])) {
    ...
    echo $_REQUEST["tollid"] . " tolli on " . ($_REQUEST["tollid"] * 2.54) . " cm.";
}
?>
<form action="?"> Laual on mitu sentimeetrit ruumi:
